...
namespace TestHelper
{
    public static class Helper
    {
        ...
        public static Task<bool> CallPrivateTask(string taskName, object instance, object[] parameters = null, bool inBaseClass = false)
        {
            if (parameters == null)
            {
                parameters = new object[] { };
            ...
            Type myType = inBaseClass
                ? instance.GetType().BaseType
                : instance.GetType();
            MethodInfo privateMethod = myType.GetMethod(taskName, BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
            if (privateMethod == null)
            {
            ...
            {
                return Task.Run(() => (Task<bool>)privateMethod.Invoke(instance, parameters));
            }
        }

        public static Task<bool> CallPrivateTaskBool(string taskName, object instance, object[] parameters = null, bool inBaseClass = false)
        {
            if (parameters == null)
            {
                parameters = new object[] { };
            ...
            {
                var nonGenericMethod = privateMethod.MakeGenericMethod(typeof(bool));
                return Task.Run(() => (Task<bool>)nonGenericMethod.Invoke(instance, parameters));
            }
        }
